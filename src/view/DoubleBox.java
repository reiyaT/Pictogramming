...
public class DoubleBox extends VariableBox{
    public DoubleBox(PApplet p,VariableConstruction var,boolean seeValue,int depth){
    ...
    protected void draw(){
        ...
        p.strokeWeight(3);
        ColorSet.variableColor(p, "double", alpha);
