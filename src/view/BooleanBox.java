...
public class BooleanBox extends VariableBox{
    public BooleanBox(PApplet p,VariableConstruction var,boolean seeValue,int depth){
    ...
    protected void draw(){
        ...
        p.strokeWeight(3);
        ColorSet.variableColor(p, "boolean", alpha);
